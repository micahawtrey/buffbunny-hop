...
class RecentWorkoutQueries(Queries):
    ...
    def delete_recent_workout(self, recent_workout_id):
        try:
            ...
            return {"message": "Unable to delete recent workout"}

    def create_recent_workout(self, recent_workout_in: RecentWorkoutIn, account_id: str):
        try:
            ...
            recent_workout["created_on"] = str(recent_workout["created_on"])
        except Exception as e:
            raise HTTPException(

...
from models import RecentWorkoutIn, RecentWorkoutOut, Error, Deleted
from authenticator import authenticator

router = APIRouter()

@router.post("/api/recent_workouts", response_model=Union[RecentWorkoutOut, Error])
...
@router.get("/api/recent_workouts", response_model=Union[List[RecentWorkoutOut], Error])
